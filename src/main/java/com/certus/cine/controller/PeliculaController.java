...
public class PeliculaController {
	...
	public PeliculaRespuesta listarPeliculas(
		...
		return peliculaServicio.obtenerTodasLasPeliculas(numeroDePagina, medidaDePagina, ordenarPor, sortDir);
	}
	...
	@PutMapping("/{id}")
	public ResponseEntity<PeliculaDTO> actualizarPelicula(@RequestBody PeliculaDTO peliculaDTO,
